...
<head>
    ...
    <link rel="stylesheet" href="../stylesheets/cruises.css">
...
<body>
    ...
    <nav>
        ...
        <a href="../html/cruises.jsp" class="active">Cruises</a>
    </nav>
    <p class="text">Find lucrative deals on Cruises..</p>
    <div class="input-container">
        <form action="" class="form">
            ...
            <span >
                <input type="date" placeholder="Mon,Feb19 - Mon,Feb26" class="calender">
            ...
            <span >
                <input type="time" placeholder="Mon,Feb19 - Mon,Feb26" class="calender">
                <i class="fa-regular fa-clock fa-xl"></i>
            </span>
            <span>
                <input type="text" placeholder="1 Traveler . 1 Room" class="people">
